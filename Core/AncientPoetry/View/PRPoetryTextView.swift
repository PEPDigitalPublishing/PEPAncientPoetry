//
//  PRPoetryTextView.swift
//  PEPRead
//
//  Created by sunShine on 2024/4/9.
//  Copyright © 2024 PEP. All rights reserved.
//

import Foundation
/// 单行的歌词效果View
public class PRPoetryTextView : UIView {
    // MARK: 🍎🍎🍎 开始绘制 🍎🍎🍎
...
// MARK: 🍎🍎🍎 播放进度处理 🍎🍎🍎
extension PRPoetryTextView : CAAnimationDelegate {
    /// 播放完毕的代理
    ...
    public func playAnimation(_ duration: CGFloat, completion: (()->Void)? = nil) {
        ...
        keyaAnimation.calculationMode = CAAnimationCalculationMode.cubic//linear  cubic
